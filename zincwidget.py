...
#         self._selection_notifier.setCallback(self._zincSelectionEvent)
    ...
    def _zincSceneviewerEvent(self, event):
        ...
        if event.getChangeFlags() & Sceneviewerevent.CHANGE_FLAG_REPAINT_REQUIRED:
            self.updateGL()
#         elif event.getChangeFlags() & Sceneviewerevent.CHANGE_FLAG_NONE:
#             pass
#         elif event.getChangeFlags() & Sceneviewerevent.CHANGE_FLAG_TRANSFORM:
#             pass
#         elif event.getChangeFlags() & Sceneviewerevent.CHANGE_FLAG_FINAL:
#             pass
#         print "_zincSceneviewerEvent", event.getChangeFlags()
